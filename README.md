...
In this project, we investigate the application of supervised machine learning techniques to predict the price based on different features of the car. Different techniques like linear regression analysis, and decision trees have been used to make the predictions.INTRODUCTION
